/**
 * https://github.com/huang-kai/SnowFlakeSample/blob/master/src/main/java/SnowFlakeIDWorker.java
 */
public class SnowFlakeIDWorker01 {
    ...
    public SnowFlakeIDWorker01(final long workerId) {
        super();
    ...
    public static void main(String[] args) {
        SnowFlakeIDWorker01 worker= new SnowFlakeIDWorker01(4);
